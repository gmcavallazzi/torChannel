"""Back-compat shim: `import projection` resolves to `torchannel.projection`.
...
`import projection` and `import torchannel.projection`.

New code should import from `torchannel` directly.
"""
import sys

from torchannel import projection as _module
