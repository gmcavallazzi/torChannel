...
4 & 0.138 & 0.281 & 1.914 & 0.355 &  3.571 & 0.250 \\
5 & {---} & {---}  & {---} & {---}  &  3.496 & 0.245 \\
\bottomrule
\end{tabular}
...
longer-domain sweep is planned). The $\Sc=10$, $N=4$ entry is the
near-converged near-inlet value (time-march still running to the
$1.2{\times}10^5$-step cap used by the other $N$).}
\label{tab:lmix}
\end{table}
...
\addplot[black,thick,solid,mark=*] coordinates
  {(0,1.000)(1,0.616)(2,0.402)(3,0.309)(4,0.281)};
