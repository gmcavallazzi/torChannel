#!/bin/bash
#SBATCH --job-name=re180_ext
#SBATCH --partition=compute
#SBATCH --nodes=1
#SBATCH --output=slurm-re180-ext-%j.out

# Re_tau = 180 open-channel validation case (torChannel OSS release).
# Seeded from an equilibrated CaNS field; see examples/re180_open/config_extend.yaml.
...
python main.py examples/re180_open/config_extend.yaml
