"""Back-compat shim: `import turbstats` resolves to `torchannel.turbstats`.
...
`import turbstats` and `import torchannel.turbstats`.

New code should import from `torchannel` directly.
"""
import sys

from torchannel import turbstats as _module
