"""Back-compat shim: `import operators` resolves to `torchannel.operators`.
...
`import operators` and `import torchannel.operators`.

New code should import from `torchannel` directly.
"""
import sys

from torchannel import operators as _module
